...
PackageInfo usePackageInfo<PageKeyType, ItemType>({
  ...
  String placeholderAppName = 'Unknown',

  /// The package name. `bundleIdentifier` on iOS, `getPackageName` on Android.
  String placeholderPackageName = 'Unknown',

  /// The package version. `CFBundleShortVersionString` on iOS, `versionName` on Android.
  String placeholderVersion = 'Unknown',

  /// The build number. `CFBundleVersion` on iOS, `versionCode` on Android.
  String placeholderBuildNumber = 'Unknown',
  ...
  return use(
    _PackageInfoHook(
      ...
      buildNumber: placeholderBuildNumber,
      packageName: placeholderPackageName,
